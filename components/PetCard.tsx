  ...
  return (
    ...
    >
      ...
      <div className="relative h-52 w-full bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
        ...
        {post.imageUrl && <div className="absolute inset-0 gradient-overlay opacity-0 group-hover:opacity-100 transition-opacity duration-300" />}

        {/* Status Badge */}
        <div className={`absolute top-3 left-3 px-3 py-1.5 rounded-full text-xs font-bold text-white uppercase tracking-wider shadow-lg ${isLost ? 'bg-coral-500' : 'bg-teal-400'}`}>
      ...
      <div className="p-5 flex flex-col flex-grow">
        <h3 className="font-bold text-lg text-gray-800 line-clamp-1 mb-2 group-hover:text-coral-600 transition-colors">{post.title}</h3>

        <p className="text-gray-500 text-sm mb-4 line-clamp-2 flex-grow leading-relaxed">{post.description}</p>
