      ...
      <div className="bg-white rounded-3xl w-full max-w-2xl max-h-[90vh] overflow-hidden shadow-2xl animate-slide-up">
        ...
        <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-coral-50 to-teal-50">
          <div className="flex justify-between items-center">
            ...
            <button onClick={onClose} className="text-gray-400 hover:text-gray-600 p-2 hover:bg-white/50 rounded-xl transition-colors">
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-180px)]">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Тип животного</label>
                <select
                    name="animalType"
            ...
            <div>
                <label className="block text-sm font-medium text-gray-700 mb-1.5">Вознаграждение (необязательно)</label>
                <div className="relative">
                  ...
                  />
                  <svg className="w-5 h-5 absolute left-3 top-3.5 text-warm-400" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-200 border-dashed rounded-2xl hover:bg-gray-50 hover:border-coral-300 transition-all cursor-pointer relative group">
                    <div className="space-y-1 text-center">
                        {(formData.imageUrl || imagePreview) ? (
                            <div className="relative">
                                <img src={formData.imageUrl || imagePreview || ''} alt="Preview" className={`mx-auto h-48 object-contain rounded-lg ${isUploading ? 'opacity-50' : ''}`} />
                                {isUploading && (
                            ...
                            <>
                                <div className="w-16 h-16 mx-auto bg-gray-100 rounded-2xl flex items-center justify-center group-hover:bg-coral-100 transition-colors">
                                  <svg className="w-8 h-8 text-gray-400 group-hover:text-coral-500 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="p-6 border-t border-gray-100 bg-gray-50/50 flex justify-end gap-3">
            <button type="button" onClick={onClose} className="px-5 py-2.5 border border-gray-200 rounded-xl text-gray-700 hover:bg-white font-medium transition-colors">Отмена</button>
            <button
