    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center gap-2">
                ...
                <span className="font-bold text-xl text-gray-900 tracking-tight">PetReunite<span className="text-blue-600">AI</span></span>
              </div>
            </div>
              ...
              {user ? (
                <>
                  ...
                  <div className="flex items-center gap-3 ml-2">
                    ...
                    <button onClick={handleLogout} className="text-sm text-gray-500 hover:text-gray-900 font-medium">Log out</button>
                  </div>
                </>
              ) : (
                <button 
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 w-full">
        ...
        <div className="mb-8 text-center sm:text-left">
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Find your missing friend.</h1>
            <p className="text-gray-600 max-w-2xl">
                PetReunite uses advanced AI to match lost pet reports with found animals in your area instantly.
            </p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mb-8">
            ...
            <div className="flex p-1 space-x-1 bg-gray-200 rounded-xl w-full sm:w-auto">
                {(['ALL', PostType.LOST, PostType.FOUND] as const).map((tab) => (
                    ...
                    >
                        {tab === 'ALL' ? 'All Posts' : tab === PostType.LOST ? 'Lost Pets' : 'Found Pets'}
                    </button>
                ))}
            </div>
            ...
            <form onSubmit={handleSearch} className="relative w-full sm:w-96">
                <input
                    ...
                    placeholder="Search by breed, color, or location (AI powered)..."
                    value={searchQuery}
                  ...
                  <div className="p-8">
                      ...
                      <div className="border-t border-gray-100 pt-6">
                           <div className="flex items-center gap-3">
                               ...
                               <div>
                                   <p className="text-sm font-medium text-gray-900">Posted by {selectedPost.user.name}</p>
                                   <p className="text-xs text-gray-500">{selectedPost.user.verified ? 'Verified User' : 'Unverified'}</p>
                               </div>
                           </div>
                      </div>
                  </div>
